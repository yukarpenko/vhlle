...
void Fluid::outputGnuplot(double tau)
{
  ...
  << setw(14) << nb <<  setw(14) << t <<  setw(14) << mub ;
	...
	foutx << setw(14) <<c->getpi(3,3) << setw(14) << c->getPi() << setw(14)<<c->getViscCorrCutFlag() << endl;
	}
	foutx << endl ;
  ...
  << setw(14) << nb <<  setw(14) << t <<  setw(14) << mub ;
	...
	fouty << setw(14) <<c->getpi(3,3) << setw(14) << c->getPi() << setw(14)<<c->getViscCorrCutFlag() << endl;
	}
	fouty << endl ;
  ...
  << setw(14) << vy << setw(14) << e << setw(14) << nb <<  setw(14) << t <<  setw(14) << mub << endl ;
	...
	foutdiag << setw(14) <<c->getpi(3,3) << setw(14) << c->getPi() << setw(14)<<c->getViscCorrCutFlag() << endl;
	}
	foutdiag << endl ;
  ...
  << setw(14) << nb <<  setw(14) << t <<  setw(14) << mub ;
	...
	foutz << setw(14) <<c->getpi(3,3) << setw(14) << c->getPi() << setw(14)<<c->getViscCorrCutFlag() << endl;
	}
	foutz << endl ;
