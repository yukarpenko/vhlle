...
void Jets::propagate(double tau, double dtau) {
  ...
  int iJet = 0;
  fjets << setw(10) << tau << setw(14) << jets[iJet].X() << setw(14)
        << jets[iJet].Y() << setw(14) << jets[iJet].Eta() << setw(14)
        << jets[iJet].Mt() * cosh(jets[iJet].Rap()) << setw(14)
        << jets[iJet].Px() << setw(14) << jets[iJet].Py() << setw(14)
        << jets[iJet].Mt() * sinh(jets[iJet].Rap()) << endl;
}
