...
// ---- auxiliary EoS class. Six instances (objects) of this class will be created
...
EoSAZHaux::EoSAZHaux(const char *filename)
{
  ...
  cout<<endl ;
  cout<<"EoSaux: table "<<filename<<" read, [ne nb] = "<<ne<<"  "<<nn<<"  done\n" ;
}
...
void EoSAZH::eos(double e, double nb, double nq, double ns,
