...
public:
  const double etaS0, zetaS0, ah, al, aRho, etaSMin, etaSEpsilonMin, T0, etaSAlphaMuB, 
  ...
  const int zetaSparam, etaSparam;
  ...
  TransportCoeff(double _etaS0, double _zetaS0, int _zetaSparam, EoS *_eos, int _etaSparam, double _ah,
    double _al, double _aRho, double _T0, double _etaSMin, double _etaSEpsilonMin, double _etaSAlphaMuB,
    double _etaSScaleMuB, double _zetaSPeakEpsilon, double _zetaSScaleBeta, double _zetaSSigmaMinus,
    double _zetaSSigmaPlus) : etaS0(_etaS0), zetaS0(_zetaS0), zetaSparam(_zetaSparam), eos(_eos), etaSparam(_etaSparam), 
          ah(_ah), al(_al), aRho(_aRho), T0(_T0), etaSMin(_etaSMin), etaSEpsilonMin(_etaSEpsilonMin), 
          etaSAlphaMuB(_etaSAlphaMuB), etaSScaleMuB(_etaSScaleMuB), zetaSPeakEpsilon(_zetaSPeakEpsilon), 
          zetaSScaleBeta(_zetaSScaleBeta), zetaSSigmaMinus(_zetaSSigmaMinus), zetaSSigmaPlus(_zetaSSigmaPlus){};
  ~TransportCoeff(){};
  void printZetaT();
