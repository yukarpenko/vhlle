...
extern "C" void initeoshlle3f_(char* filename, double* B, double* volex0,
                               double* delta0, double* aaa, double* bbb);
extern "C" void initeoshlle1f_(char* filename);
extern "C" void inittrcoeff_(double* etaS, double* zetaS);
extern "C" void eoshlle_(double* e, double* nb, double* nq, double* ns,
                         double* T, double* mub, double* muq, double* mus,
                         double* p);
extern "C" void eosrangeshlle_(double* emax, double* e0, double* nmax,
                               double* n0, int* ne, int* nn);
extern "C" void initfluidhlle_(int* nx, int* ny, int* nz, double* minx,
                               double* maxx, double* miny, double* maxy,
                               double* minz, double* maxz);
extern "C" void initichlle_(char* filename, double* tau0);
extern "C" void icgethlle3f_(double* x, double* y, double* eta, double* e,
                             double* nb, double* nq, double* ns, double* vx,
                             double* vy, double* vz);
extern "C" void icgethlle_(double* x, double* y, double* eta, double* e,
                           double* nb, double* nq, double* ns, double* vx,
                           double* vy, double* vz);
// icsethlle: ix=1..nx, iy=1..ny, iz=1..nz
extern "C" void icsethlle_(int* ix, int* iy, int* iz, double* tau0, double* e,
                           double* nb, double* nq, double* ns, double* vx,
                           double* vy, double* vz);
...
extern "C" void getvalueshlle_(int* ix, int* iy, int* iz, double* e, double* p,
                               double* nb, double* nq, double* ns, double* vx,
                               double* vy, double* vz, double* viscCorrCutFlag);
// getvflaghlle: get viscCorrCutFlag only
extern "C" void getvflaghlle_(int* ix, int* iy, int* iz,
